...
export default function Notfound() {
  ...
  return (
    <>
      <section className="notfound py-25 flex justify-center items-center flex-col">
        <h2 className="text-stone-950 text-6xl font-extrabold">Oops! Page Not Found</h2>
        ...
        <div className="flex flex-col rounded-2xl bg-bgColor p-6 my-6 text-center space-y-4 shadow-xl">
          ...
          <div className="gap-2 text-center mt-2 flex justify-center items-center">
